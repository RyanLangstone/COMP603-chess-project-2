 ...
 * 
 * The default board state is saved in the default.txt
 * it writes the standard initial chess setup(white pieces at the bottom and black at the top)
 * it can reload the default board from file or recreate it if its missing
 *
 * 
 */
public class BoardFileIO {
    ...
    public static void loadDefaultBoard()
    {
        try {
        ReadBoardFileTest.ReadBoardFile(DEFAULT_FILE); //Tries loading default board from the file
        } catch (Exception e)
        {
